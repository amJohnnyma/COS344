...
// Explicit instantiations of the matrix-multiply member template.
// operator*<a> produces a Matrix<n,a> from a Matrix<n,m> * Matrix<m,a>.
// Add a line here any time a new (n,m,a) combination is needed.
template Matrix<2,2> Matrix<2,2>::operator*<2>(Matrix<2,2>) const;
template Matrix<3,3> Matrix<3,3>::operator*<3>(Matrix<3,3>) const;
template Matrix<4,4> Matrix<4,4>::operator*<4>(Matrix<4,4>) const;
// Vector multiply: Matrix<n,n> * Matrix<n,1> → Matrix<n,1>
template Matrix<2,1> Matrix<2,2>::operator*<1>(Matrix<2,1>) const;
template Matrix<3,1> Matrix<3,3>::operator*<1>(Matrix<3,1>) const;
template Matrix<4,1> Matrix<4,4>::operator*<1>(Matrix<4,1>) const;
